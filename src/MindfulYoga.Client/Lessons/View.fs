...
let lessonsGapa = [
    ...
    { Title = "Čtvrtek, 18:15 – 19:25"; Name = "Mindful easy flow"; Description = "Jemné plynutí na vlně dechu, během kterého postupně rozproudíme energii v celém těle. Zůstáváme v kontaktu s tím, co se v nás děje a pomáháme tělu přebytečné napětí a stres uvolnit. Lehce dynamická jóga se zaměřením na protažení a posílení celého těla.<br/>Vhodné pro začátečníky i pro pokročilejší jogíny."}
    { Title = "Čtvrtek, 19:40 – 20:50"; Name = "Mindful yoga pro zdravá záda"; Description = "Klidná lekce všímavé jógy se zaměřením na zmírnění a prevenci bolestí zad. Protahujeme zkrácené svaly trupu a posilujeme ochablé svaly, které neposkytují dobrou oporu. Podporujeme správné držení těla a aktivujeme hluboký stabilizační systém páteře.<br/>Vhodné pro všechny."}
]
